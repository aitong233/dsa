package com.spadea.xqipao.echart;
...
import com.spadea.xqipao.echart.db.UserDao;
import com.spadea.xqipao.echart.domain.EmojiconExampleGroupData;
import com.spadea.xqipao.echart.domain.InviteMessage;
import com.spadea.xqipao.echart.domain.RobotUser;
import com.spadea.xqipao.echart.parse.UserProfileManager;
import com.spadea.xqipao.echart.receiver.HeadsetReceiver;
import com.tencent.bugly.crashreport.CrashReport;
import com.tendcloud.tenddata.TCAgent;
import com.spadea.yuyin.R;
import com.spadea.xqipao.ui.chart.activity.ChatActivity;
...
public class EChartHelper {
    ...
    protected static final String TAG = "EChartHelper";
    ...
    private static EChartHelper instance = null;

    private EChartModel demoModel = null;
    ...
    private EChartHelper() {
        executor = Executors.newCachedThreadPool();
    }

    public synchronized static EChartHelper getInstance() {
        if (instance == null) {
            instance = new EChartHelper();
        }
        return instance;
    }
    ...
    public void init(Context context) {
        demoModel = new EChartModel(context);
...
//        options.setPushConfig(builder.build());
    ...
    public class MyContactListener implements EMContactListener {
        ...
        public void onContactDeleted(String username) {
            Map<String, EaseUser> localUsers = EChartHelper.getInstance().getContactList();
...
//                break;
    ...
    protected void onUserException(String exception) {
        exception=exception+"userId:"+ MyApplication.getInstance().getUser().getUser_code();
        TCAgent.onError(MyApplication.getInstance(),new RuntimeException(exception));
        CrashReport.postCatchedException(new RuntimeException(exception));
...
//        showToast(exception);
        ...
        messageListener = new EMMessageListener() {
            ...
            public void onMessageReceived(List<EMMessage> messages) {
                for (EMMessage message : messages) {
                    ...
                    String data = JSON.toJSONString(easeUser);
                    if (!easeUI.hasForegroundActivies() && message.getChatType() == ChatType.Chat) {
    ...
    public EChartModel getModel() {
        return (EChartModel) demoModel;
    }
    ...
    synchronized void reset() {
        ...
        EChartDBManager.getInstance(appContext).closeDB();
    }
    ...
    public void setSettingMsgSound(boolean b){
        demoModel.setSettingMsgSound(b);
    }

    public void setSettingMsgVibrate(boolean b){
        demoModel.setSettingMsgVibrate(b);
    }
