...
import com.spadea.xqipao.utils.view.room.template.EmotionRoomOnClickListener;
import com.spadea.xqipao.utils.view.room.template.EmotionRoomView;
...
public class EmotionRoomFragment extends BaseRoomFragment<RoomFragmentPresenter> implements EmotionRoomOnClickListener, XBanner.OnItemClickListener, RoomFragmentContacts.View {
    ...
    private final static String TAG = EmotionRoomFragment.class.getName();
    ...
    public void applyWheatSuccess(ApplyWheatSuccessEvent event){
        if (emojiconRoomView!=null){
            emojiconRoomView.setSelfWheatData(event.pitNumber);
        }
    }

    @Override
    protected void initData() {
        emojiconRoomView.addEmotionRoomOnClickListener(this);
    ...
    protected void initView(View rootView) {
        ...
        emojiconRoomView = rootView.findViewById(R.id.emojicon_room_view);
    ...
    public void setWheatData(List housePitBeanList) {
        if (emojiconRoomView != null)
            emojiconRoomView.setWheatData(housePitBeanList);
    }
    ...
    public void showVolumeTips(String pitNum, boolean b) {
        if (emojiconRoomView != null)
            emojiconRoomView.showWheatVolumeTips(pitNum, b);
    }
    ...
    public void roomDeleteCardiac(String pitNumber) {
        emojiconRoomView.deleteCardiac(pitNumber);
    }

    @Override
    public void roomDeleteAllCardiac() {
        emojiconRoomView.deleteAllCardiac();
    }

    @Override
    public void roomClosePit(String pitNumber, String action) {
        emojiconRoomView.closePit(pitNumber, action);
    }
    ...
    public void roomShutup(String pitNumber, int shutup) {
        emojiconRoomView.roomShutup(pitNumber, shutup);
    }

    @Override
    public void setWheatCardiac(String pitNum, String cardiac) {
        emojiconRoomView.setWheatCardiac(pitNum, cardiac);
    }
    ...
    public void showPitCountDown(String pitNum, String time) {
        emojiconRoomView.pitCountDown(pitNum, time);
    }
    ...
    public void setExpression(FaceBean data) {
        emojiconRoomView.setWheatExpression(data);
    }
    ...
    public void showGift(int postion, String animation) {
        emojiconRoomView.showWheatGift(postion, animation);
    }
    ...
    public void setContribution(String contribution) {
        emojiconRoomView.setRoomContribution(contribution);
    }

    @Override
    public void showGame(String pitNum) {
        emojiconRoomView.showWheatGame(pitNum);
    }

    @Override
    public void overGame(String pitNum) {
        emojiconRoomView.overWheatGame(pitNum);
    }

    @Override
    public void openGame(String pitNum, String qiu1, String qiu2, String qiu3) {
        emojiconRoomView.openWheatGame(pitNum, qiu1, qiu2, qiu3);
    }

    @Override
    public void showCardiac(int cardiac) {
        emojiconRoomView.showWheatCardiac(cardiac);
    }
