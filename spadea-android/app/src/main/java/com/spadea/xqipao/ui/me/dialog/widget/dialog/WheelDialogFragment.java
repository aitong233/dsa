package com.spadea.xqipao.ui.me.dialog.widget.dialog;
...
import com.spadea.xqipao.ui.me.dialog.widget.BaseDialogFragment;
import com.spadea.xqipao.ui.me.dialog.widget.WheelView;
...
public class WheelDialogFragment extends BaseDialogFragment implements WheelView.OnValueChangeListener {
    ...
    protected void setSubView() {
        ...
        wheelView.setDividerColor(MyApplication.getInstance().getResources().getColor(R.color.color_main));
        wheelView.setSelectedTextColor(MyApplication.getInstance().getResources().getColor(R.color.color_main));
        wheelView.setNormalTextColor(MyApplication.getInstance().getResources().getColor(R.color.color_545454));
    }
