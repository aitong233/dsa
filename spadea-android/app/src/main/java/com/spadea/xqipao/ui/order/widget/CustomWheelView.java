package com.spadea.xqipao.ui.order.widget;
...
public class CustomWheelView extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attrs) {
        if (attrs != null) {
            ...
            itemCount = a.getInt(R.styleable.CustomWheelView_wheelItemCount, itemCount);
            dividerColor = a.getColor(R.styleable.CustomWheelView_dividerColor, dividerColor);
            itemSize = a.getDimensionPixelOffset(R.styleable.CustomWheelView_wheelItemSize, itemSize);
            dividerSize = a.getDimensionPixelOffset(R.styleable.CustomWheelView_wheelDividerSize, dividerSize);
            orientation = a.getInt(R.styleable.CustomWheelView_wheelOrientation, orientation);
            gravity = a.getInt(R.styleable.CustomWheelView_wheelGravity, gravity);
            a.recycle();
        }
