...
public class SlideBar extends View {
    ...
    public SlideBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        int mTextColor = a.getColor(R.styleable.SlideBar_textColor, Color.parseColor("#30A0FF"));
        float dimension = a.getDimension(R.styleable.SlideBar_textSize, 10);
        b = a.getBoolean(R.styleable.SlideBar_isHight, false);
