...
public class StatusBarUtil {
    ...
    public static void initTransP(View topView, int dp) {
        BarUtils.setStatusBarAlpha((Activity) topView.getContext(), 0);
        BarUtils.setAndroidNativeLightStatusBar((Activity) topView.getContext(), false);
        topView.setPadding(topView.getPaddingLeft(), StatusBarUtil.getStatusBarHeight(topView.getContext()) + SizeUtils.dp2px(dp), topView.getPaddingRight(), topView.getPaddingBottom());
    }
}