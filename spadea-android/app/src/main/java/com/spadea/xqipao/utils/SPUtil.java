...
public class SPUtil {
    ...
    public static void saveString(String key, String value) {
        SharedPreferences sp = MyApplication.getContext().getSharedPreferences(PreferenceName,
    ...
    public static String[] getSharedPreference(String key) {
        String regularEx = "#";
        String[] str = null;
        SharedPreferences sp =  MyApplication.getInstance().getSharedPreferences("data", Context.MODE_PRIVATE);
        String values;
