...
import com.spadea.yuyin.util.utilcode.constant.MemoryConstants;
...
public final class ImageUtils {
    ...
    public static void shareImg(Context context, String name, ViewGroup v) {
        if (FileUtils.createOrExistsDir(Constants.IMAGE_PATH)) {
            ...
            if (save(addImageWatermark(getScrollViewBitmap(v), getBitmap(R.drawable.ic_launcher), ScreenUtils.getScreenWidth() / 2 - 150, SizeUtils.dp2px(15), 255), file, CompressFormat.JPEG, false)) {
