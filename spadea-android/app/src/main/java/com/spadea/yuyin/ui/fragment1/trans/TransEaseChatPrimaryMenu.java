 ...
 *
 */
public class TransEaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public TransEaseChatPrimaryMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public TransEaseChatPrimaryMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TransEaseChatPrimaryMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.trans_ease_widget_chat_primary_menu, this);
