 ...
 */
public class TransEaseChatInputMenu extends LinearLayout {
    ...
    public TransEaseChatInputMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public TransEaseChatInputMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TransEaseChatInputMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        layoutInflater.inflate(R.layout.trans_ease_widget_chat_input_menu, this);
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (chatPrimaryMenu == null) {
            chatPrimaryMenu = (TransEaseChatPrimaryMenu) layoutInflater.inflate(R.layout.trans_ease_layout_chat_primary_menu, null);
        }
