...
public final class ToastUtils {
    ...
    public static void showLong(@NonNull final CharSequence text) {
        showCustom(text, Toast.LENGTH_LONG);
    }
    ...
    private static void show(@StringRes final int resId, final int duration) {
        showCustom(Utils.getApp().getResources().getText(resId).toString(), duration);
    }

    private static void show(@StringRes final int resId, final int duration, final Object... args) {
        showCustom(String.format(Utils.getApp().getResources().getString(resId), args), duration);
    }

    private static void show(final String format, final int duration, final Object... args) {
        showCustom(String.format(format, args), duration);
    }
    ...
    private static void showCustom(final CharSequence text, final int duration) {
        HANDLER.post(new Runnable() {
            @Override
            public void run() {
