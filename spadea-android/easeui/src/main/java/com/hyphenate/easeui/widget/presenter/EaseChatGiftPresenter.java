...
public class EaseChatGiftPresenter extends EaseChatRowPresenter {
    private static final String TAG = "EaseChatGiftPresenter";

    @Override
    protected EaseChatRow onCreateChatRow(Context cxt, EMMessage message, int position, BaseAdapter adapter) {
        return new EaseChatRowGift(cxt, message, position, adapter);
    }
