...
public class EaseConstant {
    ...
    public static final String EXTRA_MSG_ACTION = "action";

    public static final String EXTRA_MSG_STATUS_MSG = "status_msg";
    ...
    public static final String PUBLIC_SCREEN_MESSAGE_TYPE = "action";
