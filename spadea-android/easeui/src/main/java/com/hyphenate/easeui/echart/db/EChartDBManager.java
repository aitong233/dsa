...
public class EChartDBManager {
    static private EChartDBManager dbMgr = null;
    private DbOpenHelper dbHelper;

    private EChartDBManager(Context mContext) {
        dbHelper = DbOpenHelper.getInstance(mContext);
    }

    public static synchronized EChartDBManager getInstance(Context mContext) {
        if (dbMgr == null) {
            dbMgr = new EChartDBManager(mContext);
        }
        return dbMgr;
    }
