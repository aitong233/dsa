 ...
 * 加入直播间
 */
public class NewJoinRoomChatRow extends EaseChatRow {
    ...
    public NewJoinRoomChatRow(Context context, EMMessage message, int position, BaseAdapter adapter) {
        super(context, message, position, adapter);
    }

    @Override
    protected void onInflateView() {
        inflater.inflate(R.layout.ease_row_received_message_join_room, this);
    }
