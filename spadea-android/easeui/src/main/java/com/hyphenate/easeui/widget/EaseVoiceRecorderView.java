 ...
 * Voice recorder view
 */
public class EaseVoiceRecorderView extends LinearLayout {
    ...
    protected ImageView micImageBack;
    ...
    private void init(Context context) {
        ...
        micImageBack = findViewById(R.id.mic_image_cancel);
        ...
        wakeLock = ((PowerManager) context.getSystemService(Context.POWER_SERVICE)).newWakeLock(
                PowerManager.SCREEN_DIM_WAKE_LOCK, "qpyy:chat");
    }
    ...
    public void showReleaseToCancelHint() {
        ...
        micImageBack.setVisibility(VISIBLE);
        micImage.setVisibility(GONE);
    }

    public void showMoveUpToCancelHint() {
        recordingHint.setText(context.getString(R.string.move_up_to_cancel));
        micImageBack.setVisibility(GONE);
