 ...
 * primary menu
 */
public class RoomEaseChatPrimaryMenu extends EaseChatPrimaryMenuBase implements OnClickListener {
    ...
    public RoomEaseChatPrimaryMenu(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context, attrs);
    }

    public RoomEaseChatPrimaryMenu(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RoomEaseChatPrimaryMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(final Context context, AttributeSet attrs) {
        ...
        LayoutInflater.from(context).inflate(R.layout.ease_room_widget_chat_primary_menu, this);
