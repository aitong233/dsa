 ...
 */
public class RoomEaseChatInputMenu extends LinearLayout {
    ...
    public RoomEaseChatInputMenu(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public RoomEaseChatInputMenu(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoomEaseChatInputMenu(Context context) {
        super(context);
        init(context, null);
    }
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        layoutInflater.inflate(R.layout.ease_room_widget_chat_input_menu, this);
    ...
    public void init(List<EaseEmojiconGroupEntity> emojiconGroupList) {
        ...
        if (chatPrimaryMenu == null) {
            chatPrimaryMenu = (RoomEaseChatPrimaryMenu) layoutInflater.inflate(R.layout.ease_room_layout_chat_primary_menu, null);
        }
     ...
     * register menu item
     *
     * @param resource    id of item name
     * @param drawableRes background of item
     * @param itemId      id
     * @param listener    on click event of item
     */
