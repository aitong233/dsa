...
public class RoomEaseChatMessageList extends RelativeLayout {
    ...
    public RoomEaseChatMessageList(Context context, AttributeSet attrs, int defStyle) {
        this(context, attrs);
    }

    public RoomEaseChatMessageList(Context context, AttributeSet attrs) {
        super(context, attrs);
        parseStyle(context, attrs);
        init(context);
    }

    public RoomEaseChatMessageList(Context context) {
        super(context);
        init(context);
    }
