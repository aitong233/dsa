package com.hyphenate.easeui.echart.parse;
...
import com.hyphenate.easeui.echart.PreferenceManager;
...
public class UserProfileManager {
     ...
     */
    private List<EChartHelper.DataSyncListener> syncContactInfosListeners;
    ...
    public synchronized boolean init(Context context) {
        ...
        syncContactInfosListeners = new ArrayList<EChartHelper.DataSyncListener>();
        sdkInited = true;
        return true;
    }

    public void addSyncContactInfoListener(EChartHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
    ...
    public void removeSyncContactInfoListener(EChartHelper.DataSyncListener listener) {
        if (listener == null) {
            return;
        }
        if (syncContactInfosListeners.contains(listener)) {
    ...
    public void asyncFetchContactInfosFromServer(List<String> usernames, final EMValueCallBack<List<EaseUser>> callback) {
        ...
        ParseManager.getInstance().getContactInfos(usernames, new EMValueCallBack<List<EaseUser>>() {
            ...
            public void onSuccess(List<EaseUser> value) {
                ...
                // return immediately
                if (!EChartHelper.getInstance().isLoggedIn()) {
                    return;
                }
                if (callback != null) {
    ...
    public void notifyContactInfosSyncListener(boolean success) {
        for (EChartHelper.DataSyncListener listener : syncContactInfosListeners) {
