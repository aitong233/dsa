...
public class EaseChatRowText extends EaseChatRow {
    ...
    private LinearLayout redPackLayout;
    ...
    protected void onFindViewById() {
        ...
        redPackLayout = findViewById(R.id.ll_red_pack);
    }
    ...
    public void onSetUpView() {
        ...
        String price = message.getStringAttribute("price", "0");
        if (!price.equals("0")) {
            contentView.setVisibility(View.GONE);
            redPackLayout.setVisibility(VISIBLE);
            ivCoin.setVisibility(VISIBLE);
            bubbleLayout.setBackgroundResource(R.drawable.ease_bg_hongbao);
            tvPrice.setText(price);
        } else {
            contentView.setVisibility(View.VISIBLE);
            redPackLayout.setVisibility(GONE);
            ivCoin.setVisibility(GONE);
