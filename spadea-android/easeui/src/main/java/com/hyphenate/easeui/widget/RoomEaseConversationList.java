...
import com.hyphenate.easeui.adapter.RoomEaseConversationAdapter;

import java.util.List;

public class RoomEaseConversationList extends ListView {
    ...
    protected RoomEaseConversationAdapter adapter;
    protected List<EMConversation> passedListRef = null;


    public RoomEaseConversationList(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RoomEaseConversationList(Context context, AttributeSet attrs, int defStyle) {
    ...
    public void init(List<EMConversation> conversationList, EaseConversationList.EaseConversationListHelper helper) {
        ...
        adapter = new RoomEaseConversationAdapter(context, 0, conversationList);
