 ...
 */
public class RoomEaseConversationAdapter extends ArrayAdapter<EMConversation> {
    ...
    public RoomEaseConversationAdapter(Context context, int resource,
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.room_ease_row_chat_history, parent, false);
        }
        ...
        if (conversation.getType() == EMConversationType.GroupChat) {
            ...
            try {
                ...
                holder.list_itease_layout.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        EventBus.getDefault().post(new RoomChatEvent(conversation.conversationId(), nickname, avatar));
                    }
                });
            } catch (Exception e) {
                e.printStackTrace();
