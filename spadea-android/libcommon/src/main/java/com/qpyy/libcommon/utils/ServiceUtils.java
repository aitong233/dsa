...
public final class ServiceUtils {
    ...
    public static Set getAllRunningService() {
        ActivityManager am =
                (ActivityManager) BaseApplication.getIns().getSystemService(Context.ACTIVITY_SERVICE);
    ...
    public static void startService(final Class<?> cls) {
        Intent intent = new Intent(BaseApplication.getIns(), cls);
        BaseApplication.getIns().startService(intent);
    }
    ...
    public static boolean stopService(final Class<?> cls) {
        Intent intent = new Intent(BaseApplication.getIns(), cls);
        return BaseApplication.getIns().stopService(intent);
    }
    ...
    public static void bindService(final Class<?> cls,
                                   ...
                                   final int flags) {
        Intent intent = new Intent(BaseApplication.getIns(), cls);
        BaseApplication.getIns().bindService(intent, conn, flags);
    }
    ...
    public static void unbindService(final ServiceConnection conn) {
        BaseApplication.getIns().unbindService(conn);
    }
